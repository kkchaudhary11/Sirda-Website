...
echo "
    <li><a href='registration.php' class='link'>Student Registration</a></li>
    ...
    <li><a href='post_admin_add.php' class='link'>Post</a></li>
	    <li><a href='teacher_progress.php? t=$t' class='link'>Progress</a></li>

	 <li><a href='marks.php? b=$b & c=$c & y=$y ' class='link'>Enter Marks</a><li>";
}
else
{
	echo "Expired";
